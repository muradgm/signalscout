...
const TRUST_SIGNAL_RULES: Array<{ label: string; patterns: RegExp[] }> = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bdigital treatment planning\b/,
      /\badvanced imaging\b/,
      /\bmodern treatment rooms?\b/,
      /\bstate-of-the-art\b/,
      /\bmodern technology\b/,
      /\bmoderne technologie\b/,
      /\bmoderne zahnmedizin\b/,
      /\bcutting-edge\b/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /\baquarium\b/,
      /\bpatientenfreundlich(?:e|er|en)?\b/,
      /\bpatient-friendly\b/,
      /\bfeel comfortable\b/,
      /\bcalm atmosphere\b/,
      /\bcalm patient care\b/,
      /\bcalm chairside experience\b/,
      /\bcalm consultation flow\b/,
      /\bcalm support\b/,
      /\bgentle support\b/,
      /\bsupportive care\b/,
      /\bpatient comfort\b/,
      /\bsanfte betreuung\b/,
      /\bkindgerechte behandlung\b/,
      /\bkindgerechte betreuung\b/,
      /\bruhige betreuung\b/,
      /\bpatient guidance\b/,
      /\bcalm guidance\b/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /\bschonende\b/,
      /\bschmerzfreie\b/,
      /\bruhige kommunikation\b/,
      /\bruhig(?:e|er|en)?\s+(betreuung|behandlung|atmosphare)\b/,
      /\bcalm care\b/,
      /\bclear patient guidance\b/,
      /\bgentle treatment\b/,
      /\bpain-free\b/,
    ],
  },

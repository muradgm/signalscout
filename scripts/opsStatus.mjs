...
for (const row of rows) {
  const [taskId, owner, family, state, gate, blastRadius, qaStatus, pmStatus, nextAction] = row;
...
for (const [taskId, owner, family, state, gate, blastRadius, qaStatus, pmStatus, nextAction] of rows) {
